...
$result = $mysqli->query("insert into motoform values('','$civilite','$name','$prenom','$adresse','$ville','$code_postal','$date_de_naissance','$tel1','$tel2','$email','$date_obt_permis','$profession','$usage_vehicule','$marque_voi','$model_voi','$energie','$coefmalus','$motif_resil','$info_comp','$term_condition')");
if($result){
    ?>
