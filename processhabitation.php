...
try
{
    ...
    $result = $mysqli->query("insert into habitaform values('','$civilite','$name','$prenom','$nomsociete','$adresse','$ville','$code_postal','$date_de_naissance','$tel1','$tel2','$email','$email2','$info_comp','$term_condition')");
